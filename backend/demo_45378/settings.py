"""
Django settings for demo_45378 project.
...
WSGI_APPLICATION = 'demo_45378.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_45378 API",
    "DESCRIPTION": "API documentation for demo_45378 App",
    "VERSION": "v1",
}
